...
public class MaterialWaveView extends View implements MaterialHeadListener {
    ...
    public void onPull(MaterialRefreshLayout br, float fraction) {
        setHeadHeight((int) (MaterialUtil.dip2px(getContext(), DefaulHeadHeight) * MaterialUtil.limitValue(1, fraction)));
        setWaveHeight((int) (MaterialUtil.dip2px(getContext(), DefaulWaveHeight) * Math.max(0, fraction - 1)));
        invalidate();
    }
    ...
    public void onRefreshing(MaterialRefreshLayout br) {
        setHeadHeight((int) (MaterialUtil.dip2px(getContext(), DefaulHeadHeight)));
